local module = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["DDude"] = {
		...
		["Effect"] = {
			Name = "Stud",
			Description = "When you target this fighter, destroy it and lock all fighters for two turns.",
			["Type"] = "OnTarget",
			["Power"] = {{"Damage",1000},{"Lock",2,"All"}},
			Target = "Self",
		},
	...
	["Overseer Prophet"] = {
		...
		["Effect"] = {
			Name = "Demon Eye",
			Description = "Gain 1 Green icon and reduce the Health of all Non-Overseers by 200.",
			["Type"] = "OnSummon",
			["Power"] = {{"Green",2},{"Damage",200}},
			Target = "NotArchetype",
		},
