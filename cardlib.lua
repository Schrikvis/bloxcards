local module = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Cat's Eye Corpse Stealer"] = {
		...
		["Effect"] = {
			Name = "Harassing Talons",
			Description = "Your opponent loses 400 life and you gain 400 life. Add a Cat's Eye Cultist into your hand.",
			["Type"] = "OnSummon",
			["Power"] = {{"Inflict",400,"Opponent"},{"Inflict",-400}{"Add","Cat's Eye Cultist"}},
			Target = "Ally",
		},
