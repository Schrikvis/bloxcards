local module = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Uncomfortably"] = {
		...
		["Cost"] = {["Yellow"] = 3,["Green"] = 3,},
			["Effect"] = {
			Name = "Sneak Attack",
			Description = "When this card enters play, set your green and white icons to four, then lose all other icons. At the end of your turns, generate a green icon.",
			["Type"] = "OnSummon",
	...
	["Revelling Satyr"] = {
		...
		["Effect"] = {
			Name = "Level Up!",
			Description = "Whenever this card attacks and destroys another, level it up and raise the health of all allied fighters by 150.",
			["Type"] = "OnAttackDestroy",
			["Power"] = {{"SummonWithEffect","Hedonist Chieftain Token"},{"Damage",9999,"Self"}},
			Target = "Ally",
		},
	...
	["Hedonist Chieftain"] = {
		...
		["Effect"] = {
			Name = "Level Up!",
			Description = "Whenever this card attacks and destroys another, level it up and raise the power of all allied fighters by 150.",
			["Type"] = "OnAttackDestroy",
			["Power"] = {{"SummonWithEffect","Pleasure Maker Token"},{"Damage",9999,"Self"}},
			Target = "Ally",
		},
