local module = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Dwarvern Sentry: Gamma"] = {
		...
		["Effect"] = {
			Name = "Sentry Heart",
			Description = "When this card attacks, destroy all other allied fighters and increase the health of this card by 200. This card cannot be counter-attacked. This card can attack the turn it is summoned.",
			["Type"] = "OnAttack",
			["Power"] = {{"Heal",9999,"Self"},{"Damage",9999},{"Heal",200,"Self"}},
			Target = "Ally",
		},
