local module = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Meeboid King"] = {
		...
		["Effect"] = {
			Name = "Build Up",
			Description = "At the end of your turns, all meeboids gain 150 health and you gain 400 life.",
			["Type"] = "OnEnd",
			["Power"] = {{"Heal",150},{"Cost",-400}},
			Target = "Archetype",
		},
	...
	["Dragon's Charm"] = {
		...
		["Effect"] = {
			Name = "Plushie Amp",
			Description = [[Add an epic dragon, a legendary dragon, and another Dragon's Charm to your hand.]],
			["Type"] = "OnSummon",
			["Power"] = {{"RandomAdd","EpicDragon"},{"RandomAdd","LegendaryDragon"},{"Add","Dragon's Charm"}},
			Target = "Ally",
		},
