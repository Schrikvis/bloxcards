local stirrings = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["Hallow's Boon"] = {
		...
		["Effect"] = {
			Name = "Pyrotechnics",
			Description = "When this card enters play, lower the power of all fighters by 100. When this card dies, all fighters gain 100 power.",
			["Type"] = "OnSummon",
			["Power"] = {{"Weaken",100},{"Summon","Boon Token","Ally"},{"Damage",9999,"Self"}},
			Target = "All",
		},
	...
	["Hallow's Eradicator"] = {
		...
		["Effect"] = {
			Name = "Pyrotechnics",
			Description = "When this card enters play, all yellow fighters gain 200 power. When this card dies, allied fighters lose 300 power.",
			["Type"] = "OnSummon",
			["Power"] = {{"Weaken",200},{"Summon","Eradicator Token","Ally"},{"Damage",9999,"Self"}},
			Target = "ColorYellow",
		},
