local stirrings = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["Glaciem Knight"] = {
		...
		["Effect"] = {
			Name = "Pyrotechnics",
			Description = "Can't attack. At the end of your turns, all fighters who can't attack gain 150 Health and you gain 150 Life.",
			["Type"] = "OnEnd",
	...
	["Unspeakable Summoning"] = {
		...
		["Effect"] = {
			Name = "Stud",
			Description = "Destroy a target fighter. Your opponent summons Lezus. Lezus can't be counterattacked.",
			["Type"] = "OnSummon",
	...
	["Lezus 3"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnEnd",
			["Power"] = {{"Cost",500},{"RandomSummon", {"Lezus 1","Lezus 2","Lezus 3","Lezus 4","Lezus 5","Lezus 6"},"Ally"},{"Draw",2,"Opponent"},{"Damage",9999},{"Unlock",9999,"Archetype"}},
			Target = "Self",
		},
		["Bio"] = "",
	},
	...
	["Psychotic Freak"] = {
		...
		["Effect"] = {
			Name = "Haydoscale",
			Description = "Can't Attack. All fighters that can't attack gain 500 Health and 500 Power.",
			["Type"] = "OnSummon",
			["Power"] = {{"Heal",500,"Archetype",},{"Strengthen",500,"Archetype"}},
			Target = "Ally",
		},
	...
	["Frankenstein"] = {
		...
		["Effect"] = {
			Name = "Haydoscale",
			Description = "Can't Attack. Whenever this card survives an attack, put a random red or blue action into your hand, then put a Nightmare into your opponent's hand.",
			["Type"] = "OnAttacked",
	...
	["Edgelord"] = {
		...
		["Effect"] = {
			Name = "Stud",
			Description = "Can't attack. Whenever this fighter survives an attack, all fighters who can't attack gain 150 health and power.",
			["Type"] = "OnAttacked",
