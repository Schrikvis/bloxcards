local stirrings = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["Lezus 3"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnEnd",
			["Power"] = {{"Cost",500},{"RandomSummon", {"Lezus 1","Lezus 2","Lezus 3","Lezus 4","Lezus 5","Lezus 6"},"Ally"},{"RandomAdd","LegendaryRed"},{"RandomAdd","LegendaryRed"},{"Damage",9999},{"Unlock",9999,"Archetype"}},
			Target = "Self",
		},
		["Bio"] = "",
	},
