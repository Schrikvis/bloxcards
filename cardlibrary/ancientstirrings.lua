local stirrings = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["Dun_Boof"] = {
		...
		["Effect"] = {
			Name = "Pyrotechnics",
			Description = "Haste. Draw two cards and deal 400 damage to the opponent.",
			["Type"] = "OnSummon",
	...
	["Hidden Razor"] = {
		...
		["Effect"] = {
			Name = "Pyrotechnics",
			Description = "Deal 200 damage to all enemy fighters.",
			["Type"] = "OnSummon",
			["Power"] = {{"Damage",200}},
			Target = "Opponent",
		},
	...
	["Smiling Golem"] = {
		...
		["Effect"] = {
			Name = "Halloween",
			Description = "When Targeting Blip is cast, Smiling Golem gains 200 power.",
			["Type"] = "OnSummon",
			["Power"] = {{"Heal",0}},
			Target = "Self",
		},
	...
	["Lezus 4"] = {
		...
		["Effect"] = {
			...
			Description = "Cur!",
			["Type"] = "OnEnd",
			["Power"] = {{"Cost",500},{"RandomSummon", {"Lezus 1","Lezus 2","Lezus 3","Lezus 4","Lezus 5","Lezus 6"},"Ally"},{"Heal",400,"Opponent"},{"Strengthen",400,"Opponent"},{"Damage",9999},{"Unlock",9999,"Archetype"}},
			Target = "Self",
		},
		["Bio"] = "",
	},
	...
	["Lezus 7"] = {
		...
		["Effect"] = {
			...
			Description = "Failure!",
			["Type"] = "OnEnd",
			["Power"] = {{"Cost",500},{"RandomSummon", {"Lezus 1","Lezus 2","Lezus 3","Lezus 4","Lezus 5","Lezus 6"},"Ally"},{"RandomSummon", {"Lezus 1","Lezus 2","Lezus 3","Lezus 4","Lezus 5","Lezus 6"},"Ally"},{"Add","Nightmare","Ally"},{"Add","Nightmare","Ally"},{"Add","Nightmare","Ally"},{"Add","Nightmare","Ally"},{"Heal",400,"Opponent"},{"Strengthen",400,"Opponent"},{"Draw",2,"Opponent"},{"SetNeutral",0,"Ally"},{"Blue",3,"Opponent"},{"Green",3,"Opponent"},{"White",3,"Opponent"},{"Yellow",3,"Opponent"},{"Red",3,"Opponent"},{"Neutral",3,"Opponent"},{"Heal",400,"Archetype"},{"Heal",400,"Opponent"},{"Damage",400,"Ally"},{"Damage",9999},{"Unlock",9999,"Archetype"}},
			Target = "Self",
		},
		["Bio"] = "",
	},
	...
	["Gooplast"] = {
		...
		["Effect"] = {
			Name = "Pyrotechnics",
			Description = "Lower the power of a target fighter by 300, then lock it for 1 turn. Summon a Morphic Goo.",
			["Type"] = "OnSummon",
			["Power"] = {{"Weaken",300},{"Lock",1},{"Summon","Morphic Goo","Ally"}},
			Target = "Single",
		},
	...
	["Psychotic Freak"] = {
		...
		["Effect"] = {
			Name = "Haydoscale",
			Description = "Can't Attack. A target fighter loses 750 health, but gains 1000 power.",
			["Type"] = "OnSummon",
