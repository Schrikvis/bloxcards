local stirrings = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["Beast Within"] = {
		...
		["Effect"] = {
			...
			Description = "Each fighter gains 200 health and power, then loses 200 health and power. Lock them for two turns, then ready them twice. Draw a card.",
			["Type"] = "OnSummon",
			["Power"] = {{"Heal",200},{"Damage",200},{"Strengthen",200},{"Weaken",200},{"Lock",1},{"Lock",1},{"Unlock",1},{"Unlock",1},{"Draw",1,"Ally"}},
			Target = "Aly",
		},
	...
	["Stranglevines"] = {
		...
		["Effect"] = {
			Name = "Slander",
			Description = "Cast only if your opponent controls at least 4 fighters. Lock all enemy fighters for 2 turns.",
			["Type"] = "OnSummon",
	...
	["Lezus 7"] = {
		...
		["Effect"] = {
			...
			Description = "Failure!",
			["Type"] = "OnEnd",
			["Power"] = {{"Cost",1500},{"RandomSummon", {"Lezus 1","Lezus 2","Lezus 3","Lezus 4","Lezus 5","Lezus 6"},"Ally"},{"RandomSummon", {"Lezus 1","Lezus 2","Lezus 3","Lezus 4","Lezus 5","Lezus 6"},"Ally"},{"Add","Nightmare","Ally"},{"Add","Nightmare","Ally"},{"Add","Nightmare","Ally"},{"Add","Nightmare","Ally"},{"Heal",400,"Opponent"},{"Strengthen",400,"Opponent"},{"Draw",2,"Opponent"},{"SetNeutral",0,"Ally"},{"Blue",3,"Opponent"},{"Green",3,"Opponent"},{"White",3,"Opponent"},{"Yellow",3,"Opponent"},{"Red",3,"Opponent"},{"Neutral",3,"Opponent"},{"Heal",400,"Archetype"},{"Damage",400,"Ally"},{"Damage",9999},{"Unlock",9999,"Archetype"}},
			Target = "Self",
		},
		["Bio"] = "",
	},
	...
	["Groucho Mask"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnSummon",
			["Power"] = {{"Heal",300,"Single"},{"Green",2},{"Cost",-200}},
			Target = "Ally",
		},
	...
	["Swarm of Bats"] = {
		...
		["Effect"] = {
			Name = "Haydoscale",
			Description = "Haste. When this card is cast, lock a target fighter for 1 turn.",
			["Type"] = "OnSummon",
			["Power"] = {{"Lock",1,"Single"}},
			Target = "All",
		},
