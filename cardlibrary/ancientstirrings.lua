local stirrings = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["Haunted Overseer Armor"] = {
		...
		["Effect"] = {
			Name = "Pyrotechnics",
			Description = "When targeted, transform into an Overseer Beast. This card does not trigger any effects upon dying.",
			["Type"] = "OnTarget",
	...
	["Infected Mushrooms"] = {
		...
		["Effect"] = {
			Name = "Stud",
			Description = "Destroy target fighter if it has 200 power or less.",
			["Type"] = "OnSummon",
