local module = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["Grey Goo Scenario"] = {
		...
		["Effect"] = {
			Name = "Pyrotechnics",
			Description = "All fighters lose 400 power. Summon 4 Morphic Goos.",
			["Type"] = "OnSummon",
			["Power"] = {{"Weaken",400,"All"},{"Summon","Morphic Goo"},{"Summon","Morphic Goo"},{"Summon","Morphic Goo"},{"Summon","Morphic Goo"}},
			Target = "Ally",
		},
	...
	["Headless Horseman"] = {
		...
		["Effect"] = {
			Name = "Pyrotechnics",
			Description = "When this card dies, ressurect it and lose 500 life.",
			["Type"] = "OnDeath",
			["Power"] = {{"Summon","Headless Horseman"},{"Cost",500}},
			Target = "Ally",
		},
