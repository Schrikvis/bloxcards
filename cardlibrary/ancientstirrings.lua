local stirrings = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["Stranglevines"] = {
		...
		["Effect"] = {
			Name = "Slander",
			Description = "Your opponent must control at least 4 or more fighters to summon this card. Lock all enemy fighters for two turns.",
			["Type"] = "OnSummon",
	...
	["Wolven Blitz"] = {
		...
		["Effect"] = {
			Name = "Eviscerate",
			Description = "You must control at least 1 lycanthrope to summon this card. Deal 200 damage to a target fighter, then draw a card.",
			["Type"] = "OnSummon",
