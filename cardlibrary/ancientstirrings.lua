local stirrings = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["Creepy Toy"] = {
		...
		["Effect"] = {
			Name = "Pyrotechnics",
			Description = "When this card is cast, enemy fighters lose 100 health and power. Then, non-yellow fighters gain 100 health and power. You lose all of your yellow icons. This card can't generate icons.",
			["Type"] = "OnSummon",
			["Power"] = {{"Weaken",100},{"Damage",100},{"Strengthen",100,"NotColorYellow"},{"Heal",100,"NotColorYellow"},{"SetYellow",0,"Ally"}},
			Target = "Opponent",
		},
	...
	["Fried One Cultist"] = {
		...
		["Bio"] = "Two red/yellow enablers. Woops - Use firefighter instead!",
	},
	...
	["Infected Mushrooms"] = {
		...
		["Effect"] = {
			Name = "Stud",
			Description = "When this card is cast, destroy a target fighter if it has less than 150 power.",
			["Type"] = "OnSummon",
	...
	["Tooth Decay"] = {
		...
		["Effect"] = {
			Name = "Haydoscale",
			Description = "When this card is cast, destroy all fighters with 0 power.",
			["Type"] = "OnSummon",
