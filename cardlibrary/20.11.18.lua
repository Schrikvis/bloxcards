local twentyeleveneighteen = {
	...
	["MrDoombringer"] = {
		...
		["Effect"] = {
			Name = "Terrorise",
			Description = "When cast, deal 300 damage to a target fighter. At the end of your turn, destroy all enemy fighters with 150 or less health.",
			["Type"] = "OnSummon",
	...
	["Traumaturge"] = {
		...
		["Effect"] = {
			Name = "Night Creak",
			Description = "When this card is cast, lock a target fighter for three turns. Put a Nightmare into your opponent's hand.",
			Type = "OnSummon",
	...
	["Isaac0333"] = {
		...
		["Effect"] = {
			Name = "ASSEMBLE.",
			Description = "When this card is cast, summon four Kittens. You lose 100 life.",
			["Type"] = "OnSummon",
			["Power"] = {{"Cost",100},{"RandomSummon",{"Kitten","Kitten2","Kitten3","Kitten4","Kitten5","Kitten6","Kitten7","Kitten8","Kitten9"}},{"RandomSummon",{"Kitten","Kitten2","Kitten3","Kitten4","Kitten5","Kitten6","Kitten7","Kitten8","Kitten9"}},{"RandomSummon",{"Kitten","Kitten2","Kitten3","Kitten4","Kitten5","Kitten6","Kitten7","Kitten8","Kitten9"}},{"RandomSummon",{"Kitten","Kitten2","Kitten3","Kitten4","Kitten5","Kitten6","Kitten7","Kitten8","Kitten9"}}},
			Target = "Ally",
		},
