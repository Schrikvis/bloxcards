local twentyeleveneighteen = {
	...
	["Burning Tree"] = {
		...
		["Effect"] = {
			Name = "Firefly",
			Description = "When this card tries to attack, instead put two Forestfire Butterflies into your hand. Forestfire Butterflies can't generate icons naturally or when discarded.",
			["Type"] = "OnAttack",
	...
	["Forestfire Butterflies"] = {
		...
		["Effect"] = {
			Name = "Firefly",
			Description = "Haste. Can't generate icons naturally or when discarded. When this card is cast, put a copy of this card into your hand without this effect.",
			["Type"] = "OnSummon",
