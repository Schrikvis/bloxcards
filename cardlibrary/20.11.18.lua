local twentyeleveneighteen = {
	...
	["inechi"] = {
		...
		["Effect"] = {
			...
			Description = "Whenever a Nightmare is cast, this card gains 400 Health and Power. Then, put a Nightmare into your opponent's hand.",
			["Type"] = "OnCast",
			["Archetype"] = "Nightmare-Action",
	...
	["Alkalola"] = {
		...
		["Effect"] = {
			Name = "Overgrown",
			Description = "Haste. Whenever this card attacks, destroy all fighters with 150 health or less, then deal 50 damage to all fighters.",
			["Type"] = "OnAttack",
	...
	["Razuatix"] = {
		...
		["Effect"] = {
			Name = "Assassinate",
			Description = "When this card is cast, deal 9999 damage to a target fighter.",
			["Type"] = "OnSummon",
			["Power"] = {{"Damage",9999}},
			Target = "Single",
			Increase = 1,
	...
	["__________"] = {
		...
		["Effect"] = {
			...
			Description = "When this card is cast, you lose 1500 Life. Put a random Overseer, Zombie, Doge, and Toy card into your hand. End the turn.",
			["Type"] = "OnSummon",
