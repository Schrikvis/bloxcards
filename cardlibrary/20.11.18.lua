local twentyeleveneighteen = {
	...
	["Robot"] = {
		...
		["Effect"] = {
			Name = "Revival",
			Description = "Put a copy of this card into your hand. Robot can't generate icons. Fading.",
			["Type"] = "OnSummon",
			["Power"] = {{"Add","Robot"}},
			Target = "Ally",
		},
	...
	["LeetWizard"] = {
		...
		["AltCards"] = {
			["LeetWizard-Sun"] = {
				...
				["Effect"] = {
					Name = "🤔",
					Description = "When LeetWizard is first cast, deal 300 damage to a target fighter and lock it for 1 turn. When an enemy fighter dies, return LeetWizard to your hand and generate a red icon.",
					["Type"] = "OnSummon",
	...
	["Regular_Show"] = {
		...
		["Effect"] = {
			Name = "Disaster",
			Description = "Trigger lock-related effects of all unlocked fighters 5 times.",
			["Type"] = "OnSummon",
	...
	["RukatuKDHToken"] = {
		...
		["Effect"] = {
			Name = "Vampire",
			Description = "You lose 7500 life. If you survive, gain 2500 Life at the end of this turn. Fading.",
			["Type"] = "OnEnd",
	...
	["NullSenseStudio"] = {
		...
		["Effect"] = {
			Name = "Sandbox",
			Description = "Stealth. The next fighter you summon has an additional 500 power. Fading.",
			["Type"] = "OnAllySummon",
