local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["TZSara"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnEnd",
			["Power"] = {{"Heal",100},{"Inflict",-100,"Opponent"}},
			Target = "Ally",
		},
	...
	["Bobaman1"] = {
		...
		["Effect"] = {
			Name = "Bonk",
			Description = "Summon only if your opponent controls 4 or more fighters. Deal 400 damage to all enemy fighters.",
			["Type"] = "OnSummon",
			["Power"] = {{"Damage",400}},
			Target = "Opponent",
		},
	...
	["TheNStar"] = {
		...
		["Effect"] = {
			Name = "Nature's Gift",
			Description = "Allied fighters enter play as a copy of TheNStar.",
			["Type"] = "OnAllySummon",
			["Power"] = {{"Summon","TheNStar"},{"Damage",9999,"Aggressor"}},
			Target = "Ally",
		},
	...
	["Owen0202"] = {
		...
		["Effect"] = {
			Name = "Snipe!",
			Description = "Whenever your opponent loses life, deal 200 damage to Owen and gain 200 life.",
			["Type"] = "OnEnemyHealthGain",
