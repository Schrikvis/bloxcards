local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Witch"] = {
		...
		["Effect"] = {
			Name = "Frog-Legging",
			Description = "Whenever this fighter is targeted, lower the power of all enemy fighters by 50.",
			["Type"] = "OnTarget",
			["Power"] = "Weaken",
			Target = "Opponent",
			Increase = 50,
	...
	["Anti-Fave"] = {
		...
		["Effect"] = {
			Name = "Anti Extreme Energy Care Package",
			Description = "Whenever you cast an action or terrain spell, summon a copy of this card. This card can't generate icons.",
			["Type"] = "OnSummon",
	...
	["Isaac0333"] = {
		...
		["Effect"] = {
			Name = "ASSEMBLE.",
			Description = [[Summon 4 Forestfire Butterflies. You lose 2000 life.]],
			["Type"] = "OnSummon",
			["Power"] = {{"Cost",1500},{"Summon","Wolfbitten Noob"},{"Summon","Wolfbitten Noob"},{"Summon","Wolfbitten Noob"},{"Summon","Wolfbitten Noob"}},
			Target = "Ally",
		},
	...
	["ReeseMcBlox"] = {
		...
		["AttackEffect"] = "Lightning",
 		...
 		["Effect"] = {
 			...
 			["Type"] = "OnSummon",
 			["Power"] = {{"DeckAdd","Nightmare"},{"DeckAdd","Nightmare"},{"Draw",2}},
 			Target = "Ally",
 		},
