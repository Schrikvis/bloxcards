local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Fleskhjerta"] = {
		...
		["Effect"] = {
			Name = "Plushie Amp",
			Description = "When Fleskhjerta tries to attack, instead unlock him, and all Defenders convert 200 health to 200 power.",
			["Type"] = "OnAttack",
	...
	["Beehive"] = {
		...
		["AltCards"] = {
			["IcyBee"] = {
				...
				["Effect"] = {
					Name = "Nerf",
					Description = "Can only be summoned if you control 2 Bees. Put MrBeeBee2 into your hand at the end of each of your turns.",
					Type = "OnEnd",
					Power = {{"Add","MrBeeBee2"}},
					Target = "Ally",
				},
		...
		["Effect"] = {
			Name = "Nerf",
			Description = "Can only be summoned if you control 2 Bees. Put a Swarm into your hand at the end of each of your turns.",
			Type = "OnEnd",
			Power = {{"Add","Swarm"}},
			Target = "Ally",
		},
	...
	["inechi"] = {
		...
		["Effect"] = {
			...
			Description = "Can only be summoned if your opponent controls a fighter. All players lose 2 of each coloured icon. This effect can make players have negative icons.",
			["Type"] = "OnSummon",
