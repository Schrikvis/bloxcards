local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Mister Tea"] = {
		...
		["Effect"] = {
			Name = "Assimilate",
			Description = "Whenever your opponent gains life, they lose 800 life.",
	...
	["FatherChristmaz"] = {
		...
		["Effect"] = {
			Name = "Christmas..?",
			Description = "Can't attack. At the end of your turns, deal 200 damage to your opponent.",
			["Type"] = "OnEnd",
			["Power"] = "Inflict",
			Target = "Opponent",
			Increase = 200,
	...
	["Scrub"] = {
		...
		["Effect"] = {
			Name = "Double Bleeding",
			Description = "Whenever you cast a fighter, deal 250 damage to both players.",
			["Type"] = "OnAllySummon",
			["Power"] = {{"Inflict",250}},
			Target = "All",
		},
	...
	["Totem of Pixel"] = {
		...
		["Effect"] = {
			Name = "Totem Magic",
			Description = "At the end of your turns, all allied fighters gain 100 health and power.",
			["Type"] = "OnEnd",
			["Power"] = {{"Heal",100},{"Strengthen",100}},
			Target = "Ally",
		},
