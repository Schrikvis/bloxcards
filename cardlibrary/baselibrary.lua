local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Titan's Stone"] = {
		...
		["Effect"] = {
			Name = "Stud",
			Description = "Can't generate icons. This card is treated as a Titan. Set the power of this fighter to 0 at the end of your turns.",
			["Type"] = "OnEnd",
			["Power"] = "Weaken",
			Target = "Self",
			Increase = 9999,
	...
	["FILTHY PRANKS"] = {
		...
		["Effect"] = {
			Name = "Prakn'd",
			Description = [[As long as there are 250 or more cards in your deck, you win the game.]],
			["Type"] = "OnSummon",
			["Power"] = {"Draw",-3},
			Target = "Ally",
		},
