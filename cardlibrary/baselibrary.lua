local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Shedletsky 4"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnEnd",
			["Power"] = {{"DeckAdd","Fried One Cultist"},{"DeckAdd","Shedletsky the Fried One"},{"Draw",1},{"Summon","Shedletsky, Paragon of Unity"},{"SetHealth",0,"Self"}},
			Target = "Ally",	
		},
		["Bio"] = "Blame John.",
	},
	...
	["Greygnarl"] = {
		...
		["Effect"] = {
			Name = "Omega Cost",
			Description = "Playable only if you have 4 or more dragon-related cards in play. Increase the health and power of all dragon-related cards by 300.",
			["Type"] = "OnSummon",
	...
	["Regular_Show"] = {
		...
		["Bio"] = "Just likes the show so much he's named it too. Too bad the show is ending though...",
	},		
	...
	["Epic Sauce"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnSummon",
			["Power"] = {{"Cost",200},{"EndTurn",1},{"Add","Epic Sauce"}},
			Target = "Ally",
		},
	...
	["Classy Bear"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnSummon",
			["Power"] = {{"Heal",200},{"Return",030,"Self"}},
			Target = "All",
		},
