local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Classy Bear"] = {
		...
		["Effect"] = {
			Name = "Monocle Polish",
			Description = "Haste. Can't be counterattacked, have its stats set, or have its power increased.  When this card attacks a fighter, the fighter it attacked loses 200 power.",
			["Type"] = "OnAttack",
			["Power"] = {{"Weaken",200}},
			Target = "Aggressor",
		},
