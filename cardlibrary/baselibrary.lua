local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Ninja Trainee"] = {
		...
		["Effect"] = {
			Name = "Knockdown",
			Description = "Whenever a ninja destroys a fighter, Ninja Trainee gains 50 power and health.",
			["Type"] = "OnDestroy",
			["Archetype"] = "Ninja",		
	...
	["Eye Spy"] = {
		...
		["Effect"] = {
			Name = "Nerve Wrecker",
			Description = "All enemy fighters lose 100 Power. Put a random blue or red action into your hand.",
			["Type"] = "OnSummon",
			["Power"] = {{"Weaken",100,},{"RandomAdd","Lunar","Ally"}},
			Target = "Opponent",
		},
