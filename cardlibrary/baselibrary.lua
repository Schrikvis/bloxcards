local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Monkey"] = {
		...
		["Effect"] = {
			Name = "BANANA",
			Description = "When this card is summoned, put a copy of it into your hand. Whenever a monkey attacks, increase the power of all monkies by 100.",
			["Type"] = "OnSummon",
	...
	["MonkeyToken"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnAttack",
			["Archetype"] = "Monkey",		
			["Power"] = {{"Strengthen",100},{"Summon","MonkeyToken"},{"Damage",9999,"Self"}},
			Target = "Archetype",
		},
