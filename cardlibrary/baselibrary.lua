...
local module = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Shedletsky the Fried One"] = {		
		...
		["Effect"] = {
			Name = "Stud",
			Description = [[(UNDERGOING RENOVATION) At the end of your turns, shuffle a fried one cultist into your deck, then draw a card.]],
			["Type"] = "OnEnd",
	...
	["Shedletsky, the Raging Pulse"] = {
		...
		["Effect"] = {
			Name = "Stud",
			Description = [[At the end of your turns, shuffle a fried one cultist into your deck, then draw a card. Then deal 600 damage to the opponent.]],
			["Type"] = "OnEnd",
			["Power"] = {{"DeckAdd","Fried One Cultist"},{"Draw",1},{"Inflict",600,"Opponent"}},
			Target = "Ally",	
		},
		["Bio"] = "Blame John.",
	},
	...
	["Shedletsky, the Resonator"] = {
		...
		["Effect"] = {
			Name = "Stud",
			Description = [[(Experimental Effect) At the end of your turns, put a fried one limb into your hand, then draw a card. Then lock a target fighter for 3 turns.]],
			["Type"] = "OnEnd",
			["Power"] = {{"RandomAdd","Limb"},{"Draw",1},{"Lock",3,"Single"}},
			Target = "Ally",	
		},
		["Bio"] = "Blame John.",
	},
	...
	["Multicultural Limb"] = {
		...
		["Effect"] = {
			...
			Description = "Turn shedletsky into its yellow form.",
			["Type"] = "OnSummon",
			["Power"] = {{"SetHealth",0,"Archetype"},{"Summon","Shedletsky, Paragon of Unity"}},
			Target = "Ally",	
		},
		["Bio"] = [["Turn four Shed is completely balanced, stop whining about it!" - IcyTea 2015]],
	},
	
	["Shedletsky, Paragon of Unity"] = {
		["Id"] = 291389590,
		...
		["Effect"] = {
			Name = "Stud",
			Description = [[At the end of your turns, shuffle a fried one cultist into your deck, then draw a card. Then deal 200 damage to all enemy fighters.]],
			["Type"] = "OnEnd",
			["Power"] = {{"DeckAdd","Fried One Cultist"},{"Draw",1},{"Damage",200}},
			Target = "Ally",	
		},
		["Bio"] = "Blame John.",
	},
	...
	["Thanksgiving Feast"] = {
		...
		["Effect"] = {
			Name = "Gobble",
			Description = "Give all allied fighters 300 power at the cost of 150 health.",
			["Type"] = "OnSummon",
			["Power"] = {{"Damage",150},{"Strengthen",300}},
			Target = "Ally",
		},
	...
	["brickmason"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnSummon",
			["Power"] = {{"Weaken","500"},{"Summon","brickmasonToken","Ally"},{"SetHealth",0,"Self"}},
			Target = "Single",
		},
