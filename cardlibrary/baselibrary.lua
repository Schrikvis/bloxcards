local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Fleskhjerta"] = {
		...
		["Effect"] = {
			Name = "Plushie Amp",
			Description = "Fleskhjerta can't attack. When it tries to attack, instead all fighter that can't attack lose 200 health and gain 200 power. Activate this effect any number of times per turn.",
			["Type"] = "OnAttack",
			["Power"] = {{"Stregthen",200},{"Damage",200},{"Unlock",999,"Self"}},
			Target = "Archetype",
		},
