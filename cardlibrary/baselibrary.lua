local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Ignis Mage"] = {
		...
		["Effect"] = {
			Name = "Pyroblast",
			Description = "Deal 250 damage to a target fighter,then deal 250 damage to all green fighters. This card cannot generate icons.",
			["Type"] = "OnSummon",
			["Power"] = {{"Damage",250,"Single"},{"Damage",250}},
			Target = "ColorGreen",
		},
	...
	["Plushie Snowman"] = {
		...
		["Effect"] = {
			Name = "Snowman Amp",
			Description = "A target fighter gains 100 health. Generate a Yellow icon. Both players gain 500 Life.",
			["Type"] = "OnSummon",
			["Power"] = {{"Inflict",-500,"All"},{"Heal",100},{"Yellow",1,"Ally"}},
			Target = "Single",
		},
