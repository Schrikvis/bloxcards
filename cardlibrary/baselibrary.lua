local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Zombie Summoner"] = {
		...
		["Effect"] = {
			Name = "Stud",
			Description = "When this card is cast, summon two Zombies and give all Zombies 100 Health and Power.",
			["Type"] = "OnSummon",
			["Power"] = {{"Summon","Zombie"},{"Summon","Zombie"},{"Strengthen",100,"Archetype"},{"Heal",100,"Archetype"}},
			Target = "Ally",
		},
