local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Swarm"] = {
		...
		["AltCards"] = {
			["MrBeeBee2"] = {
				...
				["Effect"] = {
					...
					["Type"] = "OnAttack",
					["Power"] = {{"RandomAdd", {"Bee", "MrBeeBee2", "Beehive", "Beekeeper", "Queen Bee", "Tom's Bees"}}},
					Target = "Ally",
				},
		...
		["Effect"] = {
			...
			Description = "Haste. When this card attacks, put a random Bee card into your hand. This card can't generate icons.",
			["Type"] = "OnAttack",
			["Power"] = {{"RandomAdd", {"Bee", "Swarm", "Beehive", "Beekeeper", "Queen Bee", "True Hivemind"}}},
			Target = "Ally",
		},
		["Bio"] = "NOT THE BEES!!!",
	},
