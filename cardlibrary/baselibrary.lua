local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Shedletsky the Fried One"] = {		
		...
		["Effect"] = {
			Name = "Stud",
			Description = [[At the end of your turns, shuffle a fried one cultist into your deck, then draw a card. This fighter is immune to effects that lower or swap its health or power.]],
			["Type"] = "OnEnd",
	...
	["FILTHY PRANKS"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnSummon",
			["Power"] = {{"Damage",{100,200,300,400,500,1}}},
			Target = "Single",
		},
		["Bio"] = "PRANKED!",
	},	
	...
	["Remote Mine"] = {
		...
		["Effect"] = {
			Name = "Explosion",
			Description = "This card can't be discarded. When this card dies, deal 200 damage to all fighters.",
			["Type"] = "OnDeath",
			["Power"] = {{"Damage",200}},
			Target = "All",
		},
