	...
	["Snowskateer"] = {
		...
		["AltCards"] = {
			["Snowskateer-Sun"] = {
				["Name"] = "Skateskateer",
				["Id"] = 2036644572,
				["Bio"] = "In a gleeful act of self defence, Surfskateer brutally flayed the flesh of his father and used it to adorn his skateboard. He then skated across torrential peril to an ancient ninja monastery.",
				["Effect"] = {
					Name = "Assimilate",
