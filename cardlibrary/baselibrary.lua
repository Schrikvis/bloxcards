local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["Hamstermon"] = {
		...
		["Effect"] = {
			Name = "Sugar Taste",
			Description = "Must be in play for FabulousBench to be summonable. Lower the power of all fighters by 100.",
			["Type"] = "OnSummon",
			["Power"] = {{"Weaken",100}},
			Target = "Opponent",
		},
	...
	["Isaac0333"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnSummon",
			["Power"] = {{"Cost",1500},{"Summon","Kitten"},{"Summon","Kitten"},{"Summon","Kitten"},{"Summon","Kitten"}},
			Target = "Ally",
		},
