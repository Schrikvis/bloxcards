local base = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO 
	...
	["ReeseMcBlox"] = {
		...
		["AttackEffect"] = "Lightning",
 		...
 		["Effect"] = {
 			Name = "Helping Out",
 			Description = "2 charges. Lock all fighters and remove a charge. If you have charges remaining, add a copy of ReeseMcBlox to your hand.",
 			["Type"] = "OnSummon",
	...
	["ReeseMcBlox2"] = {
		...
		["AttackEffect"] = "Lightning",
 		...
 		["Effect"] = {
 			Name = "Helping Out",
 			Description = "1 charge. Lock all fighters and remove a charge. If you have charges remaining, add a copy of ReeseMcBlox to your hand.",
 			["Type"] = "OnSummon",
