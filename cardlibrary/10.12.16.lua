local tentwelvesixteen = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
  ...
  ["The Famous Destruction5033"] = {
	...
	["Llendlar"] = {
		...
		["Effect"] = {
			Name = "Aegis",
			Description = "Cast only if you control 3 Defenders. Add a random Defender to your hand, shuffle this back into your deck, and drain 500 life from your opponent.",
			["Type"] = "OnSummon",
			["Power"] = {{"RandomAdd",{"Toxic Goo","Psychotic Freak","Frankenstein","Creeperkiller510","StayBlue","MyCutenesskills","Glaciem Knight","JaikKaik","Her0z","Edgelord","FatherChristmaz","ZeDerpyDonal","Fleskhjerta","Ignis Knight","wowwow2211","Fat Cat"}},{"DeckAdd","Llendlar"},{"Cost",-500},{"Inflict",500,"Opponent"}},
			Target = "Ally",
		},
	...
	["CopperGlow"] = {
		...
		["Effect"] = {
			Name = "BLEU",
			Description = "When this card is locked, all Un-Archetyped Rare fighters gain 100 health",
			["Type"] = "OnLock",
			["Power"] = {{"Heal",100}},
			Target = "Archetype",
		},
