local tentwelvesixteen = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["emilvita"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnTarget",
			["Power"] = {{"Summon","emiltoken"},{"Summon","emiltoken"},{"Damage",9999,"Aggressor"},{"Damage",9999,"Self"}},
			Target = "Ally",
		},
	...
	["Delirious Ooze"] = {
		...
		["Effect"] = {
			Name = "befriending of scaly mutts",
			Description = "Summon six random fighters. Trigger their effects, then lose all green icons.",
			["Type"] = "OnySummon",
			["Power"] = {{"RandomSummonWithEffect","Any","Ally"},{"RandomSummonWithEffect","Any","Ally"},{"RandomSummonWithEffect","Any","Ally"},{"RandomSummonWithEffect","Any","Ally"},{"RandomSummonWithEffect","Any","Ally"},{"RandomSummonWithEffect","Any","Ally"},{"SetGreen",0}},
			Target = "Ally",
		},
	...
	["Walyn"] = {
		...
		["Effect"] = {
			Name = "Life fam",
			Description = "Whenever you gain life, Walyn gains 100 health and power.",
			["Type"] = "OnHealthGain",
	...
	["Wesker202"] = {
		...
		["Effect"] = {
			Name = "Life fam",
			Description = "Whenever you summon a fighter, Wesker gains 200 health and loses 200 power.",
			["Type"] = "OnAllySummon",
	...
	["Zabiehunter"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnSummon",
			["Power"] = {{"Summon","Zabiehuntertoken"},{"Inflict",-200,"Opponent"},{"Summon","Zombie"},{"Summon","Zombie"},{"Damage",9999,"Self"}},
			Target = "Ally",
		},
	...
	["Wizardguy34"] = {
		...
		["Effect"] = {
			Name = "Life fam",
			Description = "At the end of your turns, generate a green icon. Then all non-archetyped rares drain all health from all cards that aren't non-archetyped rares.",
			["Type"] = "OnAllyDeath",
			["Power"] = {{"Inflict",200,"Opponent"},{"Heal",200,"Self"}},
			Target = "Ally",
		},
