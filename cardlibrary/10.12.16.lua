local tentwelvesixteen = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["Round2"] = {
		...
		["Effect"] = {
			Name = "Life fam",
			Description = "Fading. When summoned, deal 150 damage to all enemy fighters. When targeted, remove a charge, reset its stats, and return this card to your hand.",
			["Type"] = "OnTarget",
  ...
  ["The Famous Destruction5033"] = {
	...
	["Lord Westinghouse"] = {
		...
		["Stealth"] = true,
 		...
 		["Archetype"] = "Chair", 
  		["Effect"] = {
  			Name = "Helping Out",
 			Description = "Cast only if you control four Chairs. Whenever you cast a Chair-related fighter, destroy that fighter and a target fighter.",
  			["Type"] = "OnAllySummon",
	...
	["Shirozaru"] = {
		...
		["Effect"] = {
			Name = "Spam",
			Description = "Cast only if an opponent controls a fighter. Summon four 400/400 Spatial Souls. Put Horologium into your hand.",
			["Type"] = "OnSummon",
