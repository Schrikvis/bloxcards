local tentwelvesixteen = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["Satyr Firemaster"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnEnd",
			["Power"] = {{"SetRed",0},{"Summon","Satyr Firemaster"},{"Inflict",250,"Opponent"}},
			Target = "Ally",
		},
	...
	["Great Paraselene Sage"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnAllySummon",
			["Power"] = {{"SetRed",0},{"Damage",9999,"Aggressor"},{"Damage",500,"Single"}},
			Target = "Ally",
		},
	...
	["Insult!"] = {
		...
		["Effect"] = {
			Name = "let's roleplay",
			Description = "Say something rude about the elemental's mother! In a fit of rage, it deals 1000 damage to all its friends and gains 3000 power!",
			["Type"] = "OnTarget",
