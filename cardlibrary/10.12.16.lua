local tentwelvesixteen = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["Wild Reporter Tracy"] = {
		...
		["AltCards"] = {
			["WildReporterTracyV2"] = {
				...
				["Effect"] = {
					...
					Description = "Reveal the opponent's hand. Whenever this card is targeted, set its stats to 750/750.",
					["Type"] = "OnSummon",
					["Power"] = {{"RevealHand",030}{"Summon","SexyAncientNews","Ally"}{"Damage",9999,"Self"}},
					Target = "Opponent",
				},		
			},
		},
		...
		["Effect"] = {
			...
			Description = "Reveal the opponent's hand. Whenever this card is targeted, set its stats to 750/750.",
			["Type"] = "OnSummon",
			["Power"] = {{"RevealHand",030}{"Summon","HotAncientNews","Ally"}{"Damage",9999,"Self"}},
			Target = "Opponent",
		},
	...
	["HotAncientNews"] = {
		...
		["Effect"] = {
			...
			Description = "Reveal the opponent's hand. Whenever this card is targeted, set its stats to 750/750.",
			["Type"] = "OnTarget",
			["Power"] = {{"SetHealth",750}{"SetPower",750}},
			Target = "Self",
		},
		["Bio"] = "Hot Ancient News.",
	},	
	...
	["Themediamogul99"] = {
		...
		["Effect"] = {
			Name = "Life fam",
			Description = "Whenever you summon a doge, summon an additional doge.",
			["Type"] = "OnAllySummon",
			["Archetype"] = "Doge",			
			["Power"] = {{"Summon","Doge"}},
			Target = "Ally",
  ...
  ["The Famous Destruction5033"] = {
	...
	["Splintered Slice"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnSummon",
			["Power"] = {{"Damage",600,"Single"},{"Add","Splintered Slice"}},
			Target = "Ally",
		},
	...
	["Enriched Neutrinous"] = {
		...
		["Effect"] = {
			Name = "Poisonous Touch",
			Description = "Whenever this card is attacked and survives, all allied fighters gain 200 health.",
			["Type"] = "OnAttacked",
			["Power"] = {{"Heal",200}},
			Target = "Ally",
		},
	...
	["Melon Desu"] = {
		...
		["Effect"] = {
			...
			Description = "Gain 2 Red icons. Put a Baseplate into your hand. (Baseplate is a terrain.)",
			["Type"] = "OnSummon",
			["Power"] = {{"Add","Baseplate"},{"Red",2}},
			Target = "Ally",
		},
	...
	["SpacielChiald"] = {
		...
		["Effect"] = {
			Name = "ARE YOU HAPPY, DAIR?",
			Description = "Gain 2 Blue icons. Put a Baseplate into your hand. (Baseplate is a terrain.)",
			["Type"] = "OnSummon",
			["Power"] = {{"Add","Baseplate"},{"Blue",2}},
			Target = "Ally",
		},
	...
	["Darr1432"] = {
		...
		["Effect"] = {
			Name = "Samkyoukindly",
			Description = "Haste. When this fighter enters play or dies, all other allied fighters gain 150 health.",
			["Type"] = "OnSummon",
			["Power"] = {{"Heal",150},{"Summon","DarrToken"},{"Unlock",1,"Archetype"},{"Damage",9999,"Self"}},
			Target = "Ally",
		},
	...
	["Despacito"] = {
		...
		["Effect"] = {
			...
			Description = "Allied fighters commit die. Return this card to your hand.",
			["Type"] = "OnSummon",
