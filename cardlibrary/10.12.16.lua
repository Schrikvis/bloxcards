local tentwelvesixteen = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["Treas0ner"] = {
		...
		["Effect"] = {
			Name = "Reincarnation",
			Description = "At the end of your turns, reset this card's health and give it 100 Power. Treasoner can't counterattack or have its power swapped.",
			["Type"] = "OnEnd",
			["Power"] = {{"SetHealth",1300},{"Strengthen",100}},
			Target = "Self",
		},
