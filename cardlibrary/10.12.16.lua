local tentwelvesixteen = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
	...
	["superkicker2005"] = {
		...
		["Effect"] = {
			Name = "Life fam",
			Description = "Can't generate icons. Play this card for free. At the end of this turn, lose 3 red icons. This effect can cause negative icons.",
			["Type"] = "OnEnd",
	...
	["caone"] = {
		...
		["Effect"] = {
			Name = "Life fam",
			Description = "Add either a Toxic Goo or a Morphic Goo to your hand.",
			["Type"] = "OnSummon",
