local tentwelvesixteen = { -- CARD_ID, NAME, POWER, HEALTH, RARITY,BIO	
  ...
  ["The Famous Destruction5033"] = {
	...
	["God's Fury 2"] = {
		...
		["Effect"] = {
			Name = "Fury",
			Description = "Deal 50 damage to a target fighter. This card doesn't trigger effects on death.",
			["Type"] = "OnSummon",
			["Power"] = {{"Damage",50}},
			Target = "Single",
		},
	...
	["Case1"] = {
		...
		["Effect"] = {
			...
			["Type"] = "OnSummon",
			["Power"] = {{"Lock",1},{"Summon","LowlyB"},{"Summon","LowlyC"},{"Summon","LowlyA"},{"Unlock",1},{"EndTurn",1,"Ally"}},
			Target = "Opponent",
		},
