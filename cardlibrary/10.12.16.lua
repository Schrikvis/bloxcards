		...
		["AltCards"] = {
			...
			["Histor, Memecraft Slayer"] = {
				...
				["Effect"] = {
					...
					Description = "Whenever an enemy fighter dies, Histor gains 200 health and power, and you lose 301 life. If you craft a Blood Pickaxe and slay the Ender Dragon with this card, you win the game.",
					["Type"] = "OnEnemyDeath",
					["Power"] = {{"Cost",301,"Ally"},{"Heal",200},{"Strengthen",200}},
					Target = "Self",
				},
